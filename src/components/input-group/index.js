...
class Component extends React.Component {
    ...
    constructor(props) {
        ...
        this.onViewOrHidePassword = this.onViewOrHidePassword.bind(this);
        ...
        return (
            <div className="form-group">
                ...
                <div className="input-group">
                    <input
                        type={this.state.isView ? "text" : type}
                        id={id}
                        name={id}
                        ...
                        className={`input-group-custom form-control ${required && this.state.errors.length > 0 && 'border border-danger'}`}
                        required={required}
                        step={step}
                    />
                    <div className="input-group-append" style={{ alignSelf: "center" }}>
                        <i className={`icon-group-custom input-group-text fa-solid ${this.state.isView ? "fa-eye" : "fa-eye-slash"}`}
                            onClick={this.onViewOrHidePassword}></i>
                    </div>
                </div>
